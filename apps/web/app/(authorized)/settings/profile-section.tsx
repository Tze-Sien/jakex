...
export function ProfileSection({ profile: initialProfile }: ProfileSectionProps) {
  ...
  const DELETE_CONFIRMATION_PHRASE = "DELETE MY DATA";
            ...
            <AlertDialogContent>
              ...
              <div className="space-y-2">
                <p className="text-sm text-muted-foreground">
                  To confirm, type <span className="font-mono font-semibold text-destructive">{DELETE_CONFIRMATION_PHRASE}</span> below:
                </p>
                <Input
              ...
              <AlertDialogFooter>
                ...
                <AlertDialogAction
                  ...
                  disabled={deleteConfirmation !== DELETE_CONFIRMATION_PHRASE || isDeleting}
