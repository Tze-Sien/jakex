...
export function AIAnalysisBox({ analysis, isLoading = false }: AIAnalysisBoxProps) {
  ...
  if (isLoading) {
    return (
      <Card className="border-primary/20 bg-gradient-to-br from-primary/5 via-blue-50/50 to-transparent dark:from-primary/10 dark:via-blue-950/20">
        <CardHeader>
  ...
  return (
    <Card ref={reportRef} className="border-primary/20 bg-gradient-to-br from-primary/5 via-blue-50/50 to-transparent dark:from-primary/10 dark:via-blue-950/20 shadow-lg">
      <CardHeader className="pb-4">
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-3">
            <div className="p-2.5 rounded-xl bg-gradient-to-br from-primary to-blue-600 shadow-md">
      ...
      {isExpanded && (
        <CardContent className="space-y-6">
          ...
          {analysis.practicalAdvice && (
            <Alert className="border-amber-300 dark:border-amber-700 bg-gradient-to-r from-amber-50 via-yellow-50 to-amber-50 dark:from-amber-950/30 dark:via-yellow-950/30 dark:to-amber-950/30">
          ...
          <div className="relative overflow-hidden rounded-xl border-2 border-primary/30 bg-gradient-to-br from-primary/10 via-white to-blue-50/50 dark:from-primary/20 dark:via-gray-900 dark:to-blue-950/30 p-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            {keyFindings && keyFindings.length > 0 && (
              <Card className="border-yellow-200 dark:border-yellow-900 bg-gradient-to-br from-yellow-50 to-amber-50/50 dark:from-yellow-950/20 dark:to-amber-950/20">
            ...
            {analysis.performanceAnalysis && (
              <Card className="border-green-200 dark:border-green-900 bg-gradient-to-br from-green-50 to-emerald-50/50 dark:from-green-950/20 dark:to-emerald-950/20">
                <CardHeader className="pb-3">
                  <CardTitle className="text-base flex items-center gap-2">
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          <div className="flex items-start justify-between gap-2 mb-2">
            ...
            <Badge variant={config.badge as any} className="text-xs shrink-0">
              {rec.priority}
            </Badge>
          </div>
